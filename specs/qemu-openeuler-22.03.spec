...
# 推荐依赖 (适配 openEuler 22.03)
BuildRequires:  dtc
# 注意: openEuler 22.03 中 libfdt-devel 包含在 dtc 包中
...
# 注意: openEuler 22.03 中使用 zstd-devel 而不是 libzstd-devel
